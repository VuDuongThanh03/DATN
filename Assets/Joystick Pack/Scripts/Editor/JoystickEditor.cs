...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty joystickOutputEvent;
    ...
    protected virtual void OnEnable()
    {
        ...
        joystickOutputEvent = serializedObject.FindProperty("joystickOutputEvent");
    }
    ...
    protected virtual void DrawComponents()
    {
        ...
        EditorGUILayout.PropertyField(joystickOutputEvent, new GUIContent("Joystick Output Event", "Event that is triggered when the joystick is moved."));
    }
}